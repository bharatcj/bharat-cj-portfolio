...
export default function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden py-32">
      <div className="glow-cyan absolute top-1/2 left-1/2 h-[36rem] w-[36rem] -translate-x-1/2 -translate-y-1/2 rounded-full" />
      <FadeIn className="relative mx-auto max-w-3xl px-6 text-center">
        <p className="mono mb-4 text-sm tracking-[0.25em] text-cyan-400 uppercase">
          Contact
        </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <a
            ...
            className="rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-cyan-500/25 transition-transform hover:scale-[1.04]"
          >
            {profile.email}
          </a>
          <a
